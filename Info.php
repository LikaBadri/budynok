...
<body>
    ...
    <section>
        <h3>Про нас</h3>
        <p>Ми заклад в якому зібрані різні напрямки творчого розвитку дітей та юнацства та їх відпочинку. В нас є декілька наравлень на вибір, в залежності від бажань дитини. При поступлені буде проводитися навеликий тест, щоб побачити знання дитини для визначення з програмою та групою. В нас є такі направлення як мистецство, музикальне, комп'ютерне, театральне, літературне, танцювальне, спортивне, творча майстерня та інші. <br>
    </section>
    <footer>
