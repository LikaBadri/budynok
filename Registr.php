...
try{
    ...
    $query = $db->prepare("SELECT COUNT(*) FROM stud WHERE email_stud LIKE :email");
    ...
    $query = $db->prepare("INSERT INTO stud (email_stud, first_name_stud, last_name_stud, middle_name_stud, phone_stud, sex_stud, pass_stud, birth_stud) 
    VALUES (:email, :first_name, :last_name, :middle_name, :phone, :sex, :pass, :birth)");

    $query->execute([":email" => $email,":first_name" => $first_name,":last_name" => $last_name, ":middle_name" => $middle_name, ":pass" => $pass, ":phone" => $phone, ":sex" => $sex, ":birth" => $birth]);
...
<header>
    ...
    ?>
        <form action="Registr.php" method="post">
            ...
            <div>
                <label for="birth">День народження:</label><br>
