...
try{
   ...
   $query = $db->prepare("INSERT INTO stud_admin (email_admin, first_name_admin, last_name_admin, middle_name_admin, phone_admin, sex_admin, pass_admin) 
    VALUES (:email, :first_name, :last_name, :middle_name, :phone, :sex, :pass)");

    $query->execute([":email" => $email,":first_name" => $first_name,":last_name" => $last_name, ":middle_name" => $middle_name, ":pass" => $pass, ":phone" => $phone, ":sex" => $sex]);
