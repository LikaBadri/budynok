...
$userID = json_decode($_COOKIE["AdminCookie"], true)["id_admin"];

$query = $db->prepare("SELECT * FROM stud_admin WHERE id_admin = :id");
...
<body>
    ...
    <section>
        <h3>Профіль</h3>
        <?php
        echo "<p>Ім'я: ".$userData["first_name_admin"]."</p>";
        echo "<p>Прізвище: ".$userData["last_name_admin"]."</p>";
        echo "<p>По батькові: ".$userData["middle_name_admin"]."</p>";
        echo "<p>Електрона пошта: ".$userData["email_admin"]."</p>";
        echo "<p>Телефон: ".$userData["phone_admin"]."</p>";
        echo "<p>Стать: ".$userData["sex_admin"]."</p>";
        ?>
</body>
</html>
