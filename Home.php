...
<body>
    ...
    <section>
        <h3>Головна</h3>
        <p>Ласкаво просимо на сайт закладку "Будинок творчості". На цьому сайті ви зможете знайти усю інформацію про сам заклад, викладачів, контакти та зможете зареструватися для навчання в цьому закладі.</p>
    </section>
    <footer>
