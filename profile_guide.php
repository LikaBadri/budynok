...
$userID = json_decode($_COOKIE["GuideCookie"], true)["id_guide"];

$query = $db->prepare("SELECT * FROM stud_guide WHERE id_guide = :id");
...
<body>
    ...
    <section>
        <h3>Профіль</h3>
        <?php
        echo "<p>Ім'я: ".$userData["first_name_guide"]."</p>";
        echo "<p>Прізвище: ".$userData["last_name_guide"]."</p>";
        echo "<p>По батькові: ".$userData["middle_name_guide"]."</p>";
        echo "<p>Електрона пошта: ".$userData["email_guide"]."</p>";
        echo "<p>Телефон: ".$userData["phone_guide"]."</p>";
        echo "<p>Стать: ".$userData["sex_guide"]."</p>";
        ?>
</body>
</html>
